!function(e, t) {
    ...
    try {
        !function() {
                ...
                decodeString: function(e, t) {
                    return this.HAS_NATIVE_SUPPORT && !t ? atob(e) : function(e) {
                        for (var t = [], r = 0, n = 0; r < e.length; ) {
                            var o, i, a, s = e[r++];
                            s < 128 ? t[n++] = String.fromCharCode(s) : 191 < s && s < 224 ? (i = e[r++],
                            t[n++] = String.fromCharCode((31 & s) << 6 | 63 & i)) : 239 < s && s < 365 ? (o = ((7 & s) << 18 | (63 & (i = e[r++])) << 12 | (63 & (a = e[r++])) << 6 | 63 & e[r++]) - 65536,
                            t[n++] = String.fromCharCode(55296 + (o >> 10)),
                            t[n++] = String.fromCharCode(56320 + (1023 & o))) : (i = e[r++],
                            a = e[r++],
                            t[n++] = String.fromCharCode((15 & s) << 12 | (63 & i) << 6 | 63 & a))
                        }
                        return t.join("")
            ...
            var u, c = "FirebaseError", p = (t(f, u = Error),
            f);
            function f(e, t, r) {
            ...
            var d = (_.prototype.create = function(e) {
                for (var t = [], r = 1; r < arguments.length; r++)
                    t[r - 1] = arguments[r];
                var n, o = t[0] || {}, i = this.service + "/" + e, e = this.errors[e], e = e ? (n = o,
            ...
            var y = (m.prototype.setInstantiationMode = function(e) {
            ...
            var w, T = "firebasestorage.googleapis.com", R = "storageBucket", k = (t(S, w = p),
            ...
            S);
            function S(e, t) {
                e = w.call(this, O(e), "Firebase Storage: " + t + " (" + O(e) + ")") || this;
                return e.customData = {
                    serverResponse: null
                },
            ...
            function C() {
                return new k("unknown","An unknown error occurred, please check the error payload for server response.")
            }
            function P() {
                return new k("canceled","User canceled the upload/download.")
            }
            function E() {
                return new k("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.")
            }
            function x(e) {
            ...
            function U(e) {
                return new k("invalid-root-operation","The operation '" + e + "' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")
            }
            function I(e, t) {
                return new k("invalid-format","String does not match format '" + e + "': " + t)
            }
            function j(e) {
            ...
            function D(e, t) {
                ...
                case M.DATA_URL:
                    return new B(function(e) {
                        e = new q(e);
                        return e.base64 ? L(M.BASE64, e.rest) : function(e) {
                            var t;
                            try {
                    ...
                    }(t),new q(t).contentType)
                }
                throw C()
            }
            function N(e) {
                for (var t = [], r = 0; r < e.length; r++) {
                    var n, o, i = e.charCodeAt(r);
                    i <= 127 ? t.push(i) : i <= 2047 ? t.push(192 | i >> 6, 128 | 63 & i) : 55296 == (64512 & i) ? r < e.length - 1 && 56320 == (64512 & e.charCodeAt(r + 1)) ? (n = i,
                    o = e.charCodeAt(++r),
                    t.push(240 | (i = 65536 | (1023 & n) << 10 | 1023 & o) >> 18, 128 | i >> 12 & 63, 128 | i >> 6 & 63, 128 | 63 & i)) : t.push(239, 191, 189) : 56320 == (64512 & i) ? t.push(239, 191, 189) : t.push(224 | i >> 12, 128 | i >> 6 & 63, 128 | 63 & i)
                }
            ...
            function L(t, e) {
                ...
                case M.BASE64:
                    var r = -1 !== e.indexOf("-")
                      , n = -1 !== e.indexOf("_");
                    if (r || n)
                        throw I(t, "Invalid character '" + (r ? "-" : "_") + "' found: is it base64url encoded?");
                    break;
                case M.BASE64URL:
                    n = -1 !== e.indexOf("+"),
                    r = -1 !== e.indexOf("/");
                    if (n || r)
                        throw I(t, "Invalid character '" + (n ? "+" : "/") + "' found: is it base64 encoded?");
            ...
            var q = function(e) {
                ...
                (this.contentType = null) === (t = e.match(/^data:([^,]+)?,/)))
                    throw I(M.DATA_URL, "Must be formatted 'data:[<mediatype>][;base64],<data>");
                var r, n = t[1] || null;
                null != n && (this.base64 = (r = ";base64",
                (t = n).length >= r.length && t.substring(t.length - r.length) === r),
            ...
            H[H.ABORT = 2] = "ABORT";
            var G = (X.prototype.send = function(e, t, r, n) {
                if (this.sent_)
                    throw j("cannot .send() more than once");
                if (this.sent_ = !0,
                this.xhr_.open(t, e, !0),
                void 0 !== n)
                    for (var o in n)
                        n.hasOwnProperty(o) && this.xhr_.setRequestHeader(o, n[o].toString());
                return void 0 !== r ? this.xhr_.send(r) : this.xhr_.send(),
                this.sendPromise_
            }
            ,
            X.prototype.getErrorCode = function() {
                if (!this.sent_)
                    throw j("cannot .getErrorCode() before sending");
                return this.errorCode_
            }
            ,
            X.prototype.getStatus = function() {
                if (!this.sent_)
                    throw j("cannot .getStatus() before sending");
                try {
            ...
            X.prototype.getResponseText = function() {
                if (!this.sent_)
                    throw j("cannot .getResponseText() before sending");
            ...
            function X() {
                ...
                this.sendPromise_ = new Promise(function(e) {
                    t.xhr_.addEventListener("abort", function() {
                        t.errorCode_ = F.ABORT,
                        e()
                    }),
                    t.xhr_.addEventListener("error", function() {
                        t.errorCode_ = F.NETWORK_ERROR,
                        e()
                    }),
            ...
            var K = (J.prototype.createConnection = function() {
                return new G
            }
            ,
            J);
            function J() {}
            var Z = (Object.defineProperty(Y.prototype, "path", {
                get: function() {
                    return this.path_
                },
                enumerable: !1,
            ...
            Y.makeFromBucketSpec = function(t, e) {
                ...
                if ("" === r.path)
                    return r;
                throw new k("invalid-default-bucket","Invalid default bucket '" + t + "'.")
            }
            ,
            Y.makeFromUrl = function(e, t) {
                ...
                for (var a = t.replace(/[.]/g, "\\."), s = [{
                    ...
                    regex: new RegExp("^https?://" + a + "/v[A-Za-z0-9_]+/b/" + n + "/o(/([^?#]*).*)?$","i"),
                    indices: {
                        bucket: 1,
                        path: 3
                    },
                    ...
                    regex: new RegExp("^https?://" + (t === T ? "(?:storage.googleapis.com|storage.cloud.google.com)" : t) + "/" + n + "/([^?#]*)","i"),
                    indices: {
                        bucket: 1,
                        path: 2
                    },
                ...
                if (null == r)
                    throw new k("invalid-url","Invalid URL '" + e + "'.");
                return r
            }
            ,
            Y);
            ...
            var $ = (Q.prototype.getPromise = function() {
            ...
            function ne(e, t, r, n) {
                if (n < t)
                    throw x("Invalid value for '" + e + "'. Expected " + t + " or greater.");
                if (r < n)
                    throw x("Invalid value for '" + e + "'. Expected " + r + " or less.")
            }
            function oe(e, t) {
                var r = t.match(/^(\w+):\/\/.+/);
                return (null == (null == r ? void 0 : r[1]) ? "https://" + t : t) + "/v0" + e
            }
            function ie(e) {
                var t, r = encodeURIComponent, n = "?";
                for (t in e)
                    e.hasOwnProperty(t) && (n = n + (r(t) + "=" + r(e[t])) + "&");
                return n = n.slice(0, -1)
            }
            var ae = (se.prototype.start_ = function() {
                var t, r, e, n, o, i, a, s, u, c = this;
                function l(e, t) {
                    var r, n = c.resolve_, o = c.reject_, i = t.connection;
                    if (t.wasSuccessCode)
                        try {
                        ...
                        null !== i ? ((r = C()).serverResponse = i.getResponseText(),
                        c.errorCallback_ ? o(c.errorCallback_(i, r)) : o(r)) : t.canceled ? o(r = (c.appDelete_ ? A : P)()) : o(r = new k("retry-limit-exceeded","Max retry time for operation exceeded, please try again."))
                }
                function h() {
                    return 2 === a
                }
                ...
                function d(e) {
                    for (var t = [], r = 1; r < arguments.length; r++)
                        t[r - 1] = arguments[r];
                    s || (e || h() || i ? p.call.apply(p, g([null, e], t)) : (n < 64 && (n *= 2),
                    f(1 === a ? (a = 2,
                    0) : 1e3 * (n + Math.random()))))
                }
                function _(e) {
                ...
                this.canceled_ ? l(0, new ue(!1,null,!0)) : this.backoffId_ = (t = function(n, e) {
                    var o;
                    function i(e) {
                        var t = e.loaded
                    ...
                    e ? n(!1, new ue(!1,null,!0)) : (o = c.pool_.createConnection(),
                    c.pendingConnection_ = o,
                    null !== c.progressCallback_ && o.addUploadProgressListener(i),
                    o.send(c.url_, c.method_, c.body_, c.headers_).then(function() {
                        null !== c.progressCallback_ && o.removeUploadProgressListener(i),
                        c.pendingConnection_ = null;
                        var e, t = o.getErrorCode() === F.NO_ERROR, r = o.getStatus();
                        t && !c.isRetryStatusCode_(r) ? (e = -1 !== c.successCodes_.indexOf(r),
                        n(!0, new ue(e,o))) : (e = o.getErrorCode() === F.ABORT,
                        n(!1, new ue(!1,null,e)))
                    }))
                }
                ,
            ...
            function ce() {
                ...
                if (re())
                    return new Blob(e);
                throw new k("unsupported-environment","This browser doesn't seem to support creating Blobs")
            }
            var le = (he.prototype.size = function() {
                return this.size_
            }
            ,
            ...
            he.prototype.slice = function(e, t) {
                if (te(this.data_)) {
                    var r = this.data_
                      , n = (o = e,
                    n = t,
                    (r = r).webkitSlice ? r.webkitSlice(o, n) : r.mozSlice ? r.mozSlice(o, n) : r.slice ? r.slice(o, n) : null);
            ...
            function he(e, t) {
                var r = 0
                  , n = "";
                te(e) ? (r = (this.data_ = e).size,
                n = e.type) : e instanceof ArrayBuffer ? (t ? this.data_ = new Uint8Array(e) : (this.data_ = new Uint8Array(e.byteLength),
                this.data_.set(new Uint8Array(e))),
                r = this.data_.length) : e instanceof Uint8Array && (t ? this.data_ = e : (this.data_ = new Uint8Array(e.length),
                this.data_.set(e)),
                r = e.length),
                this.size_ = r,
                this.type_ = n
            ...
            function ye(e, t, r) {
                t = pe(t);
                return null === t ? null : function(e, t, r) {
                    for (var n = {
                        type: "file"
            ...
            function Re(e, t, r) {
                r = pe(r);
                return null === r ? null : function(e, t, r) {
                    var n = {
                        prefixes: [],
                        items: [],
            ...
            function Oe(r, n) {
                return function(e, t) {
                    return Se(null !== (t = ye(r, t, n))),
                    t
                }
            }
            function Ce(r, n) {
                return function(e, t) {
                    return Se(null !== (t = Re(r, n, t))),
                    t
                }
            }
            function Pe(n, o) {
                return function(e, t) {
                    ...
                    function(n, e, o) {
                        if (null === (e = pe(e)))
                            return null;
                        if (!ee(e.downloadTokens))
                            return null;
                        if (0 === (e = e.downloadTokens).length)
                            return null;
                        var i = encodeURIComponent;
                        return e.split(",").map(function(e) {
                            var t = n.bucket
                              , r = n.fullPath;
                            return oe("/b/" + i(t) + "/o/" + i(r), o) + ie({
                                alt: "media",
                                token: e
                            })
                        })[0]
            ...
            function Ee(o) {
                return function(e, t) {
                    var r, n = 401 === e.getStatus() ? e.getResponseText().includes("Firebase App Check token is invalid") ? new k("unauthorized-app","This app does not have permission to access Firebase Storage on this project.") : new k("unauthenticated","User is not authenticated, please authenticate using Firebase Authentication and try again.") : 402 === e.getStatus() ? (r = o.bucket,
                    new k("quota-exceeded","Quota for bucket '" + r + "' exceeded, please view quota on https://firebase.google.com/pricing/.")) : 403 === e.getStatus() ? (n = o.path,
                    new k("unauthorized","User does not have permission to access '" + n + "'.")) : t;
                    return n.serverResponse = t.serverResponse,
                    n
                }
            }
            function xe(n) {
                ...
                return function(e, t) {
                    var r = o(e, t);
                    return 404 === e.getStatus() && (e = n.path,
                    r = new k("object-not-found","Object '" + e + "' does not exist.")),
            ...
            function Ue(e, t, r) {
                ...
                r.size = t.size(),
                r.contentType || (r.contentType = (e = t,
                (t = null) && t.contentType || e && e.type() || "application/octet-stream")),
                r
            }
            ...
            function Me(e, t) {
                ...
                return Se(!!r && -1 !== (t || ["active"]).indexOf(r)),
                r
            }
            ...
            function Ne(e, i, t, a, r, s, n, o) {
                var u = new je(0,0);
                if (n ? (u.current = n.current,
                u.total = n.total) : (u.current = 0,
                u.total = a.size()),
                a.size() !== u.total)
                    throw new k("server-file-wrong-size","Server recorded incorrect upload file size, please retry the upload.");
            ...
            var Le = function(e, t, r) {
                "function" == typeof e || null != t || null != r ? (this.next = e,
                this.error = t,
                this.complete = r) : (this.next = (e = e).next,
                this.error = e.error,
            ...
            var Fe = (He.prototype._makeProgressCallback = function() {
                var t = this
                  , r = this._transferred;
                return function(e) {
            ...
            He.prototype._resolveToken = function(n) {
                var o = this;
                Promise.all([this._ref.storage._getAuthToken(), this._ref.storage._getAppCheckToken()]).then(function(e) {
                    var t = e[0]
                      , r = e[1];
                    switch (o._state) {
                    case "running":
            ...
            He.prototype._createResumable = function() {
                ...
                this._resolveToken(function(e, t) {
                    var r = Be(n._ref.storage, n._ref._location, n._mappings, n._blob, n._metadata)
            ...
            He.prototype._continueUpload = function() {
                ...
                this._resolveToken(function(e, t) {
                    var r;
                    try {
                        r = Ne(n._ref._location, n._ref.storage, a, n._blob, o, n._mappings, i, n._makeProgressCallback())
                    } catch (e) {
                        return n._error = e,
                        void n._transition("error")
                    }
                    t = n._ref.storage._makeRequest(r, e, t);
                    (n._request = t).getPromise().then(function(e) {
                        ...
                        n._request = void 0,
                        n._updateProgress(e.current),
                        e.finalized ? (n._metadata = e.metadata,
                        n._transition("success")) : n.completeTransitions_()
                    }, n._errorHandler)
                })
            }
            ,
            ...
            He.prototype._oneShotUpload = function() {
                var n = this;
                this._resolveToken(function(e, t) {
                    var r = Ie(n._ref.storage, n._ref._location, n._mappings, n._blob, n._metadata)
                      , t = n._ref.storage._makeRequest(r, e, t);
                    (n._request = t).getPromise().then(function(e) {
                        n._request = void 0,
                        n._metadata = e,
            ...
            function He(e, t, r) {
                ...
                this._errorHandler = function(e) {
                    ...
                    e._codeEquals("canceled") ? (n._needToFetchStatus = !0,
                    n.completeTransitions_()) : (n._error = e,
                    n._transition("error"))
                }
                ,
                this._metadataErrorHandler = function(e) {
                    n._request = void 0,
                    e._codeEquals("canceled") ? n.completeTransitions_() : (n._error = e,
                    n._transition("error"))
                }
                ,
            ...
            var ze = (We.prototype.toString = function() {
            ...
            function Ge(u, c) {
                return l(this, void 0, void 0, function() {
                    ...
                    return h(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return null != c && "number" == typeof c.maxResults && ne("options.maxResults", 1, 1e3, c.maxResults),
                            s = c || {},
                            t = u.storage,
                            r = u._location,
                            n = "/",
            ...
            function Xe(s, u) {
                return l(this, void 0, void 0, function() {
                    return h(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return s._throwIfRoot("updateMetadata"),
                            t = s.storage,
                            r = s._location,
                            n = u,
                            o = be(),
            ...
            function Ke(a) {
                return l(this, void 0, void 0, function() {
                    return h(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return a._throwIfRoot("getDownloadURL"),
                            t = a.storage,
                            r = a._location,
                            n = be(),
                        ...
                        case 1:
                            return [2, e.sent().getPromise().then(function(e) {
                                if (null === e)
                                    throw new k("no-download-url","The given file does not have any download URLs.");
                                return e
                            })]
                        }
                        var t, r, n, o, i
            ...
            function Je(o) {
                return l(this, void 0, void 0, function() {
                    return h(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return o._throwIfRoot("deleteObject"),
                            t = o.storage,
                            r = o._location,
                            n = oe(r.fullServerUrl(), t.host),
                            t = t.maxOperationRetryTime,
                            (t = new ke(n,"DELETE",function(e, t) {}
                            ,t)).successCodes = [200, 204],
                            t.errorHandler = xe(r),
            ...
            function Ze(e, t) {
                var r, t = (r = e._location.path,
                t = (t = t).split("/").filter(function(e) {
                    return 0 < e.length
                }).join("/"),
                0 === r.length ? t : r + "/" + t), t = new Z(e._location.bucket,t);
            ...
            function $e(e, t) {
                if (e instanceof rt) {
                    var r = e;
                    if (null == r._bucket)
                        throw new k("no-default-bucket","No default bucket found. Did you set the '" + R + "' property when initializing the app?");
            ...
            function tt(e, t, r, n) {
                ...
                e.host = "http://" + t + ":" + r;
                n = n.mockUserToken;
                n && (e._overrideAuthToken = "string" == typeof n ? n : function(e, t) {
                    if (e.uid)
                    ...
                    [s(JSON.stringify({
                        alg: "none",
                        type: "JWT"
                    })), s(JSON.stringify(e)), ""].join(".")
                }(n, e.app.options.projectId))
            }
            var rt = (Object.defineProperty(nt.prototype, "host", {
                get: function() {
                    return this._host
                },
                set: function(e) {
                    this._host = e,
                    null != this._url ? this._bucket = Z.makeFromBucketSpec(this._url, e) : this._bucket = et(e, this.app.options)
                },
                enumerable: !1,
                configurable: !0
            }),
            ...
            nt.prototype._getAuthToken = function() {
                return l(this, void 0, void 0, function() {
                    ...
                    return h(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return this._overrideAuthToken ? [2, this._overrideAuthToken] : (t = this._authProvider.getImmediate({
                                optional: !0
                            })) ? [4, t.getToken()] : [3, 2];
                        case 1:
                            if (null !== (t = e.sent()))
                                return [2, t.accessToken];
                            e.label = 2;
                        case 2:
                            return [2, null]
                        }
            ...
            nt.prototype._makeRequest = function(e, t, r) {
                ...
                i = r,
                null !== (a = a) && 0 < a.length && (i.Authorization = "Firebase " + a),
                c = c,
                r["X-Firebase-Storage-Version"] = "webjs/" + (null != c ? c : "AppManager"),
                c = r,
                null !== (s = s) && (c["X-Firebase-AppCheck"] = s),
                new ae(t,o.method,r,o.body,o.successCodes,o.additionalRetryCodes,o.handler,o.errorHandler,o.timeout,o.progressCallback,u));
                return this._requests.add(l),
                l.getPromise().then(function() {
            ...
            function nt(e, t, r, n, o, i) {
                ...
                this._bucket = null != o ? Z.makeFromBucketSpec(o, this._host) : et(this._host, this.app.options)
            }
            function ot(e, t, r) {
                return e = v(e),
                t = t,
                ...
                return function(r) {
                    return l(this, void 0, void 0, function() {
                        ...
                        return h(this, function(e) {
                            switch (e.label) {
                            case 0:
                                return r._throwIfRoot("getMetadata"),
            ...
            var st = (Object.defineProperty(ut.prototype, "bytesTransferred", {
                get: function() {
            ...
            var ct = (Object.defineProperty(lt.prototype, "snapshot", {
                get: function() {
            ...
            var ht = (Object.defineProperty(pt.prototype, "prefixes", {
                get: function() {
                    var t = this;
            ...
            var ft = (Object.defineProperty(dt.prototype, "name", {
                get: function() {
            ...
            dt.prototype.put = function(e, t) {
                return this._throwIfRoot("put"),
                new ct(ot(this._delegate, e, t),this)
            }
            ,
            dt.prototype.putString = function(e, t, r) {
                ...
                e = D(t, e),
                r = i({}, r);
                return null == r.contentType && null != e.contentType && (r.contentType = e.contentType),
            ...
            var _t = (Object.defineProperty(gt.prototype, "maxOperationRetryTime", {
                get: function() {
            ...
            gt.prototype.ref = function(e) {
                if (Ye(e))
                    throw x("ref() expected a child path but got a URL, use refFromURL instead.");
                return new ft(at(this._delegate, e),this)
            }
            ,
            gt.prototype.refFromURL = function(e) {
                if (!Ye(e))
                    throw x("refFromURL() expected a full URL but got a child path, use ref() instead.");
                try {
            ...
            bt.INTERNAL.registerComponent(new y("storage",yt,"PUBLIC").setServiceProps(vt).setMultipleInstances(!0)),
