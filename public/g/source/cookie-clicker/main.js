...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (!App && name.indexOf('9248',name.length-('9248').length)>0 && !Game.sesame) Game.OpenSesame();
				...
				str+=
					'<div class="block" style="padding:0px;margin:8px 4px;">'+
						...
						'<div class="title">'+loc("General")+
							...
							(!App?('<div class="listing"><a class="option smallFancyButton" '+Game.clickStr+'="Game.FileSave();PlaySound(\'snd/tick.mp3\');">'+loc("Save to file")+'</a><a class="option smallFancyButton" style="position:relative;"><input id="FileLoadInput" type="file" style="cursor:pointer;opacity:0;position:absolute;left:0px;top:0px;width:100%;height:100%;" onchange="Game.FileLoad(event);" '+Game.clickStr+'="PlaySound(\'snd/tick.mp3\');"/>'+loc("ADMIN")+'</a><label>'+loc("Use this to keep backups on your computer")+'</label></div>'):'')+
